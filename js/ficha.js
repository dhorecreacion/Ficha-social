    ...
    try{
        ...
        // Si venimos por invitación → revocar permisos y cerrar
        if (inviteMeta){
        // 1) Marcar invitación como completada
        ...
        // 3) Deshabilitar UI y cerrar/redirigir
        disableForm();
        setOk("Guardado ✓ Enlace cerrado. ¡Gracias!");
        try { window.close(); } catch(_) {}
        // respaldo: logout + redirigir al login
